...
public class SimpleMd2HtmlConverterTest {
    ...
    @Test
    void convertBodyToHtml_shouldReturnEmptyString_whenInputIsNull() {
        // Arrange
        SimpleMd2HtmlConverter converter = new SimpleMd2HtmlConverter();

        // Act
        String result = converter.convertBodyToHtml(null);
    ...
    @Test
    void convertBodyToHtml_shouldReturnEmptyString_whenInputIsEmpty() {
        // Arrange
        SimpleMd2HtmlConverter converter = new SimpleMd2HtmlConverter();

        // Act
        String result = converter.convertBodyToHtml("");
    ...
    @Test
    void convertToHtml_shouldConvertMarkdownHeadingBodyToHtml() {
        // Arrange
        SimpleMd2HtmlConverter converter = new SimpleMd2HtmlConverter();
        String markdown = "# Heading";

        // Act
        String result = converter.convertBodyToHtml(markdown);
    ...
    @Test
    void convertToHtml_shouldConvertMarkdownListBodyToHtml() {
        // Arrange
        SimpleMd2HtmlConverter converter = new SimpleMd2HtmlConverter();
    ...
    @Test
    void convertToHtml_shouldConvertBoldTextBodyToHtml() {
        // Arrange
        SimpleMd2HtmlConverter converter = new SimpleMd2HtmlConverter();
    ...
    @Test
    void convertToHtml_shouldConvertItalicTextBodyToHtml() {
        // Arrange
        SimpleMd2HtmlConverter converter = new SimpleMd2HtmlConverter();
    ...
    @Test
    void convertBodyToHtml_shouldHandleMixedMarkdownElements() {
        // Arrange
        SimpleMd2HtmlConverter converter = new SimpleMd2HtmlConverter();
