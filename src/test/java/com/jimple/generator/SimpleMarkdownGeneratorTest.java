...
public class SimpleMarkdownGeneratorTest {
    ...
    void testGenerateToHtml_returnsCompleteHtml() {
        ...
        MarkdownFile mockFile = createMockMarkdownFile("Test Title", "test.md", true);
    ...
    private MarkdownFile createMockMarkdownFile(String title, String fileName, boolean isPublish) {
        MarkdownProperties props = new MarkdownProperties(isPublish, title, LocalDate.now());
        return new MarkdownFile(props, "Markdown content", fileName);
    }
}